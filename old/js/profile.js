document.addEventListener('DOMContentLoaded', () => {
    ...
    const avatarModalEl = document.getElementById('avatarEditorModal');
    if (avatarModalEl) {
        avatarEditorModal = new bootstrap.Modal(avatarModalEl);
    }
    ...
    async function loadUserProfile() {
        try {
            ...
            // Load display name
            if (displayNameInput) displayNameInput.value = profile.display_name || currentUser.user_metadata?.full_name || 'Usuario';
    ...
    function updateAvatarDisplay() {
        ...
        if (currentAvatar) currentAvatar.src = avatarUrl;
        if (avatarPreview) {
    ...
    if (editAvatarBtn) {
        editAvatarBtn.addEventListener('click', () => {
            if (!avatarControls || !avatarPreview) return;
            ...
            if (avatarEditorModal) avatarEditorModal.show();
        });
    }
    ...
    if (saveAvatarBtn) {
        saveAvatarBtn.addEventListener('click', async () => {
            try {
                ...
                updateAvatarDisplay();
                if (avatarEditorModal) avatarEditorModal.hide();
